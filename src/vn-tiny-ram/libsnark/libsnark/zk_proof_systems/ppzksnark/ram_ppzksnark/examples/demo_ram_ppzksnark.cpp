...
//    tinyram_program program = load_preprocessed_program(ap, processed);
    ...
    tinyram_program program = preprocess_raw_program(ap, raw);
    ...
    const ram_boot_trace<default_tinyram_ppzksnark_pp> boot_trace = tinyram_boot_trace_from_program_and_input2(ap, boot_trace_size_bound, program, primary_input);
