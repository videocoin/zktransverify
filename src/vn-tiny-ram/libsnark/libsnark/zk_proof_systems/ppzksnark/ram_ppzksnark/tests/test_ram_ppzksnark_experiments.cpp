                        ...
                        const size_t time_bound)
{
    ...
    const ram_example<machine_ppT> example = gen_ram_example_complex_experiment<machine_ppT>(ap, boot_trace_size_bound, time_bound, satisfiable);
...
int main()
{
    ...
    const size_t program_size = 25;
    const size_t input_size = 2;
    const size_t time_bound = 5;
