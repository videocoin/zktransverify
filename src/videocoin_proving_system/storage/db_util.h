...
int build_tree_bottom_up(tree_t *tree, const char *tree_name, const char *filename, const char *folder_name, int size,
                         int max_depth);
...
Student_handle_t create_db(int number_of_rows, int number_of_chunks, int max_depth, const char *bstore_file_name,
                           const char *folder_state = NULL);

Student_handle_t
create_compressed_db(int number_of_rows, const char *bstore_file_name, const char *folder_state = NULL);
